...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUsersUseCase(clearViewModel, clearUserDataAccessObject);
    ...
    private static ClearController createClearUsersUseCase(
            ClearViewModel clearViewModel,
